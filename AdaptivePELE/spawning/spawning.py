...
import MSM_PELE.Helpers.msm_analysis as msmp
try:
...
class SpawningCalculator:
    ...
    @abstractmethod
    def createPlots(self, outputPathConstants, currentEpoch, clusters, msm_env):
        """
        ...
        """
        if msm_env:
            msmp.analyse_results(msm_env, runTica=False)
        else:
            pass
...
class MSMCalculator(SpawningCalculator):
    ...
    def createPlots(self, outputPathConstants, currentEpoch, clusters, msm_env=False):
        """
            Create the plots to do a quick analysis of the MSM and dG calculation
